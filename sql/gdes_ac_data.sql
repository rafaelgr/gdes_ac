...
insert  into `asg_proyectos`(`asgProyectoId`,`nombre`,`proyectoId`,`trabajadorId`,`rolId`,`evaluadorId`) values (6,'Maria Esquery [Desmantelamiento Planta 3425]',6,5,1,5),(7,'Pedro LaGuardia [Desmantelamiento Planta 3425]',6,6,3,5),(8,'Juan Martin [Central 21]',7,7,2,5),(9,'Fernando Condren [Central 21]',7,8,4,5),(10,'Fernando Condren [Central 21]',7,8,1,5);
...
insert  into `catconocimientos`(`catConocimientoId`,`nombre`) values (7,'Trabajos Aluminio'),(8,'Trabajos Radiológicos'),(9,'Trabajos peligrosos');
...
insert  into `conocimientos`(`conocimientoId`,`nombre`) values (3,'Soldadura Tipo 1'),(4,'Valoración de exposición'),(5,'Ensamblado estructural'),(10,'Nuevo 2 categorias');
...
insert  into `conocimientos_categorias`(`conocimientoCategoriaId`,`conocimientoId`,`catConocimientoId`) values (11,3,7),(12,4,7),(13,4,8),(32,5,8),(33,5,9),(34,10,7);
...
insert  into `conocimientos_habilidades`(`conocimientoHabilidadId`,`conocimientoId`,`habilidadId`) values (3,5,1),(4,5,2);
...
insert  into `empresas`(`empresaId`,`nombre`) values (1,'LAI'),(2,'FALCK');
...
insert  into `evaluaciones`(`evaluacionId`,`asgProyectoId`,`conocimientoId`,`dFecha`,`hFecha`,`observaciones`) values (12,7,3,'2015-01-01 00:00:00','2015-12-31 00:00:00','Estos son los comentarios de este tipo'),(17,10,5,'2015-02-01 00:00:00','2015-06-01 00:00:00','Esta es una observacion  especial'),(18,10,4,'2015-02-01 00:00:00','2015-06-01 00:00:00','Esta es una observacion  especial de exposición'),(19,7,5,'2015-01-01 00:00:00','2015-06-13 00:00:00','Tiene una fecha nula (ya no la tiene) ss'),(20,6,4,'2015-01-01 00:00:00','2015-12-31 00:00:00',NULL),(21,7,4,'2015-01-01 00:00:00','2015-12-31 00:00:00','Es para comprobar la ruptura en dos categorias'),(22,6,3,'2015-01-04 00:00:00','2015-12-31 00:00:00','Esta es una que me gusta'),(23,9,4,'2015-02-01 00:00:00',NULL,NULL),(24,9,5,'2015-02-01 00:00:00','2015-04-10 00:00:00','Estas son algunas'),(34,8,5,'2015-02-01 00:00:00',NULL,NULL),(35,8,4,'2015-02-01 00:00:00',NULL,NULL),(37,6,5,'2015-01-04 00:00:00','2015-12-31 00:00:00','Este es un commentario');
...
insert  into `habilidades`(`habilidadId`,`nombre`,`servicioId`) values (1,'Preparador de techos2',2),(2,'Habilidad para S2',3);
...
insert  into `proyectos`(`proyectoId`,`nombre`,`fechaInicio`,`fechaFinal`) values (6,'Desmantelamiento Planta 3425','2015-01-01 00:00:00','2015-12-31 00:00:00'),(7,'Central 21','2015-02-01 00:00:00',NULL),(8,'Arranque Reactor 67','2016-10-15 00:00:00',NULL);
...
insert  into `roles`(`rolId`,`nombre`) values (1,'Jefe de proyecto'),(2,'Personal asignado'),(3,'Personal temporal'),(4,'Becario');
...
insert  into `servicios`(`servicioId`,`nombre`) values (2,'Servicio 1'),(3,'Servicios 2');
...
insert  into `trabajadores`(`trabajadorId`,`nombre`,`dni`,`login`,`password`,`evaluador`,`idioma`,`empresaId`) values (5,'Maria Esquery','2535788996','S-1-5-21-3077458779-297755452-906557366-1001','maria',1,'en',1),(6,'Pedro LaGuardia','124558788','pedro','pedro',NULL,'es',2),(7,'Juan Martin','45578787','juan','juan',NULL,'en',1),(8,'Fernando Condren 2','2547885','fernando','fernando',1,NULL,2),(9,'Juan Pansde','14522',NULL,NULL,NULL,NULL,NULL),(10,'Sheldon Cooper','24658789','cooper','cooper',NULL,'es',NULL);
