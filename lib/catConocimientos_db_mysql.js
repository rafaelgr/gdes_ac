...
// lee todos los registros de la tabla catConocimientos y
// los devuelve como una lista de objetos
module.exports.getCatConocimientosDeConocimiento = function (id, callback) {
    var connection = getConnection();
    var catConocimientos = null;
    sql = "SELECT catConocimientoId, nombre FROM catconocimientos WHERE catConocimientoId IN(SELECT catConocimientoId FROM conocimientos_categorias WHERE conocimientoId = ?);";
