...
function fromDbtoJsConocimiento(conocimientoDb){
    ...
    // antes de regresar hay que preguntar por los conocimientos
...
module.exports.getConocimientos = function(callback){
    ...
    var sql = "SELECT c.conocimientoId, c.nombre";
    sql += " FROM conocimientos AS c";
...
module.exports.postConocimientosBuscarPorCategoria = function (buscador, callback) {
    ...
    var sql = "SELECT c.conocimientoId, c.nombre";
    sql += " FROM conocimientos AS c";
    sql += " WHERE c.conocimientoId IN(SELECT conocimientoId FROM conocimientos_categorias WHERE catConocimientoId = ?)";
...
module.exports.postConocimiento = function (conocimiento, callback){
	...
	connection.query(sql, function(err, result){
        ...
        sql = "SELECT c.conocimientoId, c.nombre";
        sql += " FROM conocimientos AS c";
        sql += " WHERE c.conocimientoId = ?";
